...
plt.savefig(r'C:\Users\cavus\IdeaProjects\Future_Transportation\linear_regression_actual_vs_predicted.png', dpi=1200)
...
plt.savefig(r'C:\Users\cavus\IdeaProjects\Future_Transportation\random_forest_actual_vs_predicted.png', dpi=1200)
...
plt.savefig(r'C:\Users\cavus\IdeaProjects\Future_Transportation\gradient_boosting_actual_vs_predicted.png', dpi=1200)
...
plt.title('Linear Regression', fontsize=20)
plt.savefig(r'C:\Users\cavus\IdeaProjects\Future_Transportation\linear_regression_residuals.png', dpi=1200)
...
plt.ylabel('Residuals', fontsize=20)
plt.title('Random Forest', fontsize=20)
plt.savefig(r'C:\Users\cavus\IdeaProjects\Future_Transportation\random_forest_residuals.png', dpi=1200)
...
plt.ylabel('Residuals', fontsize=20)
plt.title('Gradient Boosting', fontsize=20)
plt.savefig(r'C:\Users\cavus\IdeaProjects\Future_Transportation\gradient_boosting_residuals.png', dpi=1200)
